...
function custom_post_type_shortcode($atts) {
    ...
    $query = new WP_Query(array(
        'post_type' => 'blog', // Replace 'your_custom_post_type' with your actual custom post type name
		'category' => 'features',
  ...
  <style>
    body {
     font-family: "Poppins", sans-serif;
      margin: 0;
      padding: 0;
      background-image: url('/wpresources/wp-content/uploads/2024/03/Green-bg.png');
     background-size: 100%;
    ...
    color: #fff;
    font-size: 45px;}
	.head p{text-align: center;color: p;font-size:18px;color:#fff;padding-bottom: 50px;}
	
		.inner_grid:nth-child(2) {
  padding-bottom: 40px!important; font-family: "Poppins", sans-serif;
}

	.inner_grid{background: #fff;
    box-shadow: 0px 5px 10px 0px rgba(0, 0, 0, 0.5);padding-bottom: 30px; font-family: "Poppins", sans-serif;}
	
	.inner_grid:hover {
    transform: scale(1.1);
    transition: transform 0.3s ease;
	}
	h3:hover{color:green} a{color: green;}
		h3, a{padding: 10px;text-decoration:none!important;}
		.post-excerpt{padding: 10px;font-family: "Poppins", sans-serif;} 

#site-header, #top-bar-wrap{display: none!important;}
</style>
...
<p>Learn how to get the most out of unified communications</p>
</div>

<?php
   // Output posts
    $output = '<div class="custom-post-type-wrapper">';
    while ($query->have_posts()) {
        $query->the_post();
        $output .= '<div class="col-md-4">';
		  $output .= '<div class="inner_grid">';
